        ...
        try {
            ...
            if (res.status === "OK") {
                if (res.user.role === "security") {
                    ...
                    setError("You do not have security access");
                }
            } else {
            ...
            <div className="w-full max-w-md relative z-10 fade-in">
                ...
                <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl hover-lift">
                    ...
                    <div className="text-center mb-8">
                        <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center shadow-lg">
                            <span className="text-2xl">🛡️</span>
                        </div>
                        <h1 className="text-3xl font-bold bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent mb-2">
                            Security Login
                        </h1>
                        <p className="text-slate-400 text-sm">Access the QR Scanner</p>
                    </div>
                    ...
                    <div className="space-y-4 mb-6">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                disabled={loading}
                                className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600 rounded-lg focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/20 smooth-transition placeholder-slate-500 disabled:opacity-50"
                            />
                    ...
                    <button
                        onClick={handleLogin}
                        disabled={loading}
                        className="w-full py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 disabled:from-slate-600 disabled:to-slate-600 text-white font-semibold rounded-lg smooth-transition shadow-lg hover:shadow-green-500/25 flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                        {loading ? (
                            <>
                    ...
                    <p className="text-center text-slate-400 text-xs mt-6">
                        Need help?{" "}
                        <a href="/forgot-password" className="text-green-400 hover:text-green-300 smooth-transition font-semibold">
                            Reset Password
                        </a>
                    </p>
                </div>
